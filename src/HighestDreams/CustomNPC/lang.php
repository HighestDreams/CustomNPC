...
class lang
{
    ...
    public const RCA_NOTFOUND = 0;
    public const NPC_EDITMODE_TUTORIAL = 1;
    public const NPC_EDITMODE_DISABLE = 2;
    public const NPC_EDITMODE_TUTORIAL2 = 3;
    public const NPC_CREATION_MSG = 4;
    ...
    public static function get(int $text)
    {
        ...
        switch ($text) {
            ...
            case self::NPC_EDITMODE_TUTORIAL:
                switch (strtolower($lang)) {
                    case 'en':
            ...
            case self::NPC_EDITMODE_TUTORIAL2:
                switch (strtolower($lang)) {
                    case 'en':
